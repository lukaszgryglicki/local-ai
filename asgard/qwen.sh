...
# MODEL=qwen35b (default; the frozen T0 winner)|qwen35b-q4 (T1 winner)|flashnext (T2 winner) - or a profile vram|fast|best - must match what asgard/serve.sh is serving: it sets
