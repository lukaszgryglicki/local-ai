...
| T2 `best\|t2` | **in progress** (winner by quality) | `qwen122b` Qwen3.5-122B-A10B UD-Q4_K_XL, k=47 MTP | 82 (pinned only) | 5.9 / 5.6 bench (depth 64 / 4 096), **4.3 codebench** | **always** (5/5 T2 loads) | run 1: 4/5 (first line only) · **run 2: PASS 5/5** | run 1: 4/5 (Scanner 64 KiB) · **run 2: 4/5 (Scanner again)** | **PASS 5/5** (98 min, 39 turns, 3.9 t/s) | off by default | results-t2.md §2.5, §3 |
| | | `qwen122b-iq4` UD-IQ4_XS, k=47 MTP | 77 (pinned) | 4.9 / 5.2 bench, **3.5 codebench** | **always** | PASS 5/5 ×2 | run 1: 4/5 (Scanner 64 KiB) · **run 2: 4/5 (Scanner again, 32 min)** | **PASS 5/5** (141 min, 40 turns, 3.6 t/s) | off | |
...
## What is running right now — 15 Sep 11:10 CEST
