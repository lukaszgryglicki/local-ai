...
| | | `qwen122b-iq4` UD-IQ4_XS, k=47 MTP | 77 (pinned) | 4.9 / 5.2 bench, **3.5 codebench** | **always** | PASS 5/5 ×2 | run 1: 4/5 (Scanner 64 KiB) · run 2 → | **PASS 5/5** (141 min, 40 turns, 3.6 t/s) | off | |
...
## What is running right now — 15 Sep 11:00 CEST
