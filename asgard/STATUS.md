...
| | | `flashnext` Qwen3.8-Flash-Next UD-IQ4_XS, k=47 none, 16 thr (no MTP layers) | 79 (pinned) | 3.3 / 2.8 bench, **3.0 codebench** | **always** | PASS 5/5 | PASS-functional 47/47 (cut before unit tests; re-run in chain 3) | **PASS 5/5** (7 h 43 min, 45 turns, 2.5 t/s, 66.9K tokens) | off | |
...
## What is running right now — 15 Sep 07:15 CEST
