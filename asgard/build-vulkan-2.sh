#!/bin/sh
# build-vulkan-2.sh - build the patched llama.cpp (patches/0001-vulkan-chunk-staging-transfers.patch + 0002-vulkan-pad-host-alloc-windows.patch)
...
cd "$SRC"
for p in /data/local-ai/asgard/patches/0001-vulkan-chunk-staging-transfers.patch \
         /data/local-ai/asgard/patches/0002-vulkan-pad-host-alloc-windows.patch; do   # 0002: pad pinned allocs out of the driver's failing size windows (results-t2.md 2.3)
